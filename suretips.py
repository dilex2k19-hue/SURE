        ...
        <div class="app-shell">
            ...
            <section class="hero">
                <div class="hero-card">
                    ...
                    <p>Search matches, filter results, and browse your predictions in a cleaner mobile-friendly layout.</p>
                </div>
            </section>
            ...
            <main class="content" id="matchesRoot">
    """
        ...
        <script>
            ...
            function applyFilters() {
                ...
                daySections.forEach(section => {
                    const visibleCards = section.querySelectorAll('.match-card[style=""], .match-card:not([style*="display: none"])');
...
def scrape_vip_matches():
    ...
    all_matches.sort(key=parse_date_safe)
